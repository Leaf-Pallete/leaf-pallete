...
export default function AboutPage() {
    return (
        <main className="px-6 py-8 max-w-prose mx-auto">
            ...
            <p className="mt-4">
                Leaf Palette is a website that acts as a helpful guide for designers. 
                It gives ideas, tips, and best ways to make amazing and useful interfaces.
            </p>
            <h2 className="mt-6 text-xl font-semibold">Our Goal</h2>
            <p className="mt-4">
                We want to help designers make great interfaces that users love. We 
                believe good design is key to making successful products, and we're 
                here to help designers reach their goals.
            </p>
